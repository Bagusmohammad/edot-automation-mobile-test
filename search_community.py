...
community_filter_search_xpath = '/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[6]/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup[3]'
list_community_search = '/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[6]/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.widget.ScrollView/android.view.ViewGroup'
...
try:
  community_filter = WebDriverWait(driver,10).until(
      EC.element_to_be_clickable((By.XPATH, community_filter_search_xpath))
  ).click()
except TimeoutException:
  logger.error("Error: Button Search Error")
time.sleep(3)
...
try:
  list_community = WebDriverWait(driver, 10).until(
      EC.visibility_of_all_elements_located((By.XPATH, list_community_search))
  )
except TimeoutException:
  logger.error("Error: Community Doesnt Appeared")

time.sleep(5)
logger.success("Search Community Test Case has been Tested")
driver.quit()